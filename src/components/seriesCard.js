...
const SeriesCard = ({ series }) => {
  ...
  return (
    <Pressable
      android_ripple={{ foreground: true, borderless: false, color: Colors.grey900 }}
      ...
      <LinearGradient colors={['transparent', '#00000033', 'black']} style={[StyleSheet.absoluteFill, styles.gradient]}>
